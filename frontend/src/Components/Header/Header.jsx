...
const Header = () => {
  return (
    <div
      id="Header"
      className="bg-slate-900 h-auto pb-10 px-16 flex flex-col overflow-clip justify-center mt-40 md:mt-20 z-10 relative mb-14">
      ...
      <div className="flex flex-col md:flex-row justify-between mx-16 pt-16">
        ...
        <a href="https://goo.gl/maps/Yrp33mok4ph5vLrs7" target="_blank">
          <div className="drop-shadow-md md:mt-0 mt-4 py-2 px-4 bg-slate-500 hover:bg-white hover:border-2 hover:border-slate-500 hover:text-slate-500 text-white rounded-lg transition-colors font-semibold flex flex-row justify-center align-middle self-center text-center items-center cursor-pointer min-w-max">
